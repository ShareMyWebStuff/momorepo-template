...
import { DockerImageAsset, NetworkMode } from 'aws-cdk-lib/aws-ecs-patterns';
...
export class VPCStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: cdk.StackProps, buildConfig: BuildConfig) {
    ...
    const dockerImageAsset = new ecs.DockerImageAsset(this, 'DockerImageAsset', {
      directory: '../tutorseekers',
    });
